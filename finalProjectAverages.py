...
NEW_AIRCRAFT = 1000 #Total number of airplanes to process
...
for x in range(50):
    ...
    sourceOneTotal += sourceOneTime
    sourceTwoTotal += sourceTwoTime
    sourceThreeTotal += sourceThreeTime
    sourceFourTotal += sourceFourTime
    sourceFiveTotal += sourceFiveTime
    sourceSixTotal += sourceSixTime
    sourceSevenTotal += sourceSevenTime
    sourceEightTotal += sourceEightTime
    sourceNineTotal += sourceNineTime
    sourceTenTotal += sourceTenTime

print("Simulation One Time: ", (sourceOneTotal / 50))
print("Simulation Two Time: ", (sourceTwoTotal / 50))
print("Simulation Three Time: ", (sourceThreeTotal / 50))
print("Simulation Four Time: ", (sourceFourTotal / 50))
print("Simulation Five Time: ", (sourceFiveTotal / 50))
print("Simulation Six Time: ", (sourceSixTotal / 50))
print("Simulation Seven Time: ", (sourceSevenTotal / 50))
print("Simulation Eight Time: ", (sourceEightTotal / 50))
print("Simulation Nine Time: ", (sourceNineTotal / 50))
print("Simulation Ten Time: ", (sourceTenTotal / 50))
#print("\n\nFINAL TIMES")
